...
// Generated by generate_substation_data.py
...
var substationDigitalPoints = []DigitalPoint{
	...
	{IOA: 2001, Value: 1, Name: "Protection relay Bay 1 trip"},          // Protection relay Bay 1 trip
	{IOA: 2002, Value: 1, Name: "Protection relay Bay 2 trip"},          // Protection relay Bay 2 trip
	{IOA: 2003, Value: 2, Name: "DC supply healthy"},                    // DC supply healthy
	{IOA: 2004, Value: 1, Name: "Alarm horn active"},                    // Alarm horn active
	{IOA: 2005, Value: 1, Name: "Buchholz transformer T1"},              // Buchholz transformer T1
}

var substationAnalogPoints = []AnalogPoint{
	{IOA: 3001, Value: 401.3000, Name: "Voltage 400kV Bus A (kV)"},             // Voltage 400kV Bus A (kV)
	{IOA: 3002, Value: 400.8000, Name: "Voltage 400kV Bus B (kV)"},             // Voltage 400kV Bus B (kV)
	{IOA: 3003, Value: 1247.5000, Name: "Current Bay 1 (A)"},                   // Current Bay 1 (A)
	{IOA: 3004, Value: 892.3000, Name: "Current Bay 2 (A)"},                    // Current Bay 2 (A)
	{IOA: 3005, Value: 499.0000, Name: "Active power Bay 1 (MW)"},              // Active power Bay 1 (MW)
	{IOA: 3006, Value: 87.3000, Name: "Reactive power Bay 1 (Mvar)"},           // Reactive power Bay 1 (Mvar)
	{IOA: 3007, Value: 357.2000, Name: "Active power Bay 2 (MW)"},              // Active power Bay 2 (MW)
	{IOA: 3008, Value: 45.1000, Name: "Reactive power Bay 2 (Mvar)"},           // Reactive power Bay 2 (Mvar)
	{IOA: 3009, Value: 49.9700, Name: "Frequency (Hz)"},                        // Frequency (Hz)
	{IOA: 3010, Value: 58.4000, Name: "Transformer T1 temperature oil (C)"},    // Transformer T1 temperature oil (C)
	{IOA: 3011, Value: 74.2000, Name: "Transformer T1 temperature winding (C)"},// Transformer T1 temperature winding (C)
	{IOA: 3012, Value: 23.5000, Name: "Cabinet temperature (C)"},               // Cabinet temperature (C)
}
